...
const admin_model_js_1 = __importDefault(require("../Model/admin.model.js"));
...
const adminMiddleware = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        try {
            ...
            const adminExist = yield admin_model_js_1.default.findById(verify._id);
            if (!adminExist) {
        ...
        console.error((err === null || err === void 0 ? void 0 : err.stack) || "stack is not defined");
